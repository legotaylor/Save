...
public class CreditsScreen extends Screen {
	...
	public void init() {
		...
		this.credits.add(new Couple<>("Author: dannytaylor", 0xAAAAAA));
	...
	public final void render(int i, int j, float f) {
		if (Data.Resources.minecraft == null || Data.Resources.minecraft.f_5854988 != null) fillGradient(0, 0, this.width, this.height, 1610941696, -1607454624);
		else {
			BufferBuilder var4 = BufferBuilder.INSTANCE;
			int var5 = Data.Resources.minecraft.f_9413506.load("/dirt.png");
			int var8 = Data.Resources.minecraft.f_0545414 * 240 / Data.Resources.minecraft.f_5990000;
			int var3 = Data.Resources.minecraft.f_5990000 * 240 / Data.Resources.minecraft.f_5990000;
